...
class TestPeriodInGpsData:
    def setup_method(self):
        file_path = FilePath(
            "/home/donkarlo/Dropbox/repo/robotic_lab_project/data/experiment/kind/oldest/robotic/robotic/uav1/structure/kind/mind/memory/explicit/long_term/episodic/normal/gaussianed_quaternion_kinematic/time_position/time_position.npz"
        )
